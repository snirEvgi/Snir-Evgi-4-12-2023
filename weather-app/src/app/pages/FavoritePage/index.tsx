              ...
              <div className="flex justify-between items-center min-h-10 max-h-10 mb-4">
                ...
                {isOnFahrenheit ? (
                  <button
                    ...
                    className="text-2xl rounded-full mt-1 hover:text-gray-800 duration-300 ease-in hover:bg-gray-300 p-2 min-h-[2rem] transition-colors"
                  >
                  ...
                  <button
                    onClick={() => handleTemperatureIndicatorSelect()}
                    className="text-2xl p-2 min-h-[2rem] duration-300 ease-in transition-colors"
                  >
                ...
                <button
                  ...
                  className="text-2xl rounded-full mt-2 hover:bg-gray-300 duration-300 ease-in hover:text-gray-800 p-2 min-h-[2rem] transition-colors"
                >
